...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xtp5th0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xtp5th0.containers.anotherwebservice.com/
...
```
git clone git@github.com:BigSam8/container-xtp5th0.git
cd container-xtp5th0
```
...
```
docker attach container-xtp5th0
```
